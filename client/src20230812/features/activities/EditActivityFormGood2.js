...
const EditActivityForm = ({ activity, users }) => {
    ...
    const [columnDefs] = useState([
        ...
        // { field: "assignment", editable: true }
        ...
        <>
            ...
            <form onSubmit={e => e.preventDefault()}>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-2 react-date-picker">
                        <DatePicker className="form-control" style="boder:0px" onChange={onStartDateChanged} value={startDate} format={'yy-MM-dd'} />
                    </div> */}
                    <div className="col-md-2">
                ...
                <div className="form-group row">
                    ...
                    <div className="table-responsive-sm">
                        <div className="ag-theme-alpine" style={{ height: 200, width: "100%" }}>
                            <AgGridReact onCellValueChanged={onCellValueChanged} defaultColDef={defaultColDef} rowData={rowData} columnDefs={columnDefs}></AgGridReact>
                        </div>
                    </div>
                </div>

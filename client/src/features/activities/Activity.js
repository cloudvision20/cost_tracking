...
const Activity = ({ activityId }) => {
    ...
    if (activity) {
        const created = new Date(activity.createdAt).toLocaleString('en-MY', { day: 'numeric', month: 'long' })

        const updated = new Date(activity.updatedAt).toLocaleString('en-MY', { day: 'numeric', month: 'long' })
        ...
        return (
            <tr className="">
                ...
                <td className="">{activity.description}</td>

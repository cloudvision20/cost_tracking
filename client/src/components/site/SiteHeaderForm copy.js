...
const SiteHeaderForm = () => {
    ...
    const onFormsAllSelected = (item) => {
        switch (item) {

            case 'Consumables':
                navigate('/site/recordsall/consumables', { state: { load: true } })
                break;
            case 'Equipment':
                navigate('/site/recordsall/equipment', { state: { load: true } })
                break;
            case 'Expenses':
                navigate('/site/recordsall/expenses', { state: { load: true } })
                break;
            default:
                break;
        }
